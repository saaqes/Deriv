...
export const REVERSE_MARTINGALE = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [`${localize('Exploring the')} Reverse Martingale ${localize('strategy in TradeLab Bot')}`],
        expanded: true,
    ...
    },
    {
        type: 'text',
        content: [
            `${localize('The')} Reverse Martingale ${localize('strategy involves increasing your stake after each successful trade and resets to the initial stake for every losing trade. This strategy aims to secure potential profits from consecutive wins.')}`,
        ],
    },
    {
        type: 'subtitle',
    ...
    },
    {
        type: 'text',
        content: [
            `${localize('These are the trade parameters used in TradeLab Bot with')} Reverse Martingale ${localize('strategy.')}`,
        ],
    },
    {
        type: 'text',
    ...
    {
        type: 'subtitle',
        content: [`${localize('An example of')} Reverse Martingale ${localize('strategy')}`],
    },
    {
        type: 'media',
        src: getImageLocation('reverse_martingale.svg'),
        alt: `${localize('An example of')} Reverse Martingale ${localize('strategy')}`,
    },
    {
        type: 'text',
        content: [
            ...
            localize(
                '3. If the first trade is a successful trade, TradeLab Bot will automatically double your stake for the next trade to 2 USD. TradeLab Bot will continue to double the stake after every successful trade.'
            ),
            localize(
    ...
    },
    {
        ...
        content: [
            localize(
                'With TradeLab Bot, traders can set the profit and loss thresholds to secure potential profits and limit potential losses. This means that the trading bot will automatically stop when either the profit or loss threshold is reached. This is a form of risk management that can potentially boost successful trades whilst limiting the impact of loss. For example, if a trader sets the profit threshold at 100 USD and the strategy exceeds 100 USD of profit from all trades, then the bot will stop running.'
            ),
        ],
    },
    {
