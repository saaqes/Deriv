...
export const guide_content = (): TGuideContent[] => [
    {
        id: 1,
        type: 'DBotVideo',
        content: localize('An introduction to TradeLab Bot'),
    ...
    },
    {
        id: 2,
        type: 'DBotVideo',
        content: localize('How to build a basic trading bot with TradeLab Bot'),
    ...
    },
    {
        id: 3,
        type: 'DBotVideo',
        content: `${localize('How to use')} Martingale ${localize('strategy on TradeLab Bot')}`,
    ...
    },
    {
        id: 4,
        type: 'DBotVideo',
        content: `${localize('Introducing')} ${localizeAccumulators()} ${localize('Options on TradeLab Bot: Available for automated trading')}`,
...
export const faq_content = (): TFaqContent[] => [
    {
        title: localize('What is TradeLab Bot?'),
        description: [
            {
                type: 'text',
                content: localize(
                    "TradeLab Bot is a web-based strategy builder for trading digital options. It’s a platform where you can build your own automated trading bot using drag-and-drop 'blocks'."
                ),
            },
        ],
        search_id: 'faq-0',
    ...
    {
        title: localize('Do you offer pre-built trading bots on TradeLab Bot?'),
        description: [
            {
                type: 'text',
    ...
    },
    {
        ...
        description: [
            {
                type: 'text',
                content: `${localize('A quick strategy is a ready-made strategy that you can use in TradeLab Bot. There are 3 quick strategies you can choose from:')} Martingale, D'Alembert, ${localize('and')} Oscar's Grind.`,
            },
            {
                type: 'text',
    ...
    {
        title: localize('How do I import my own trading bot into TradeLab Bot?'),
        description: [
            {
                type: 'text',
                content: isGoogleDriveConfigured()
    ...
    {
        title: localize('How do I control my losses with TradeLab Bot?'),
        description: [
            {
                type: 'text',
                content: localize(
                    'There are several ways to control your losses with TradeLab Bot. Here’s a simple example of how you can implement loss control in your strategy:'
                ),
            },
            {
                type: 'image',
    ...
    {
        title: localize('Can I run TradeLab Bot on multiple tabs in my web browser?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('Can I trade cryptocurrencies on TradeLab Bot?'),
        description: [
            {
                type: 'text',
                content: localize("No, we don't offer cryptocurrencies on TradeLab Bot."),
            },
        ],
        search_id: 'faq-12',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "No, we don't. However, you'll find quick strategies on TradeLab Bot that'll help you build your own trading bot for free."
                ),
            },
        ],
        search_id: 'faq-13',
    ...
    {
        title: localize('In which countries is TradeLab Bot available?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('If I close my web browser, will TradeLab Bot continue to run?'),
        description: [
            {
                type: 'text',
                content: localize('No, TradeLab Bot will stop running when your web browser is closed.'),
            },
        ],
        search_id: 'faq-15',
    },
    {
        ...
        description: [
            {
                type: 'text',
                content: `${localize('Three of the most commonly used strategies in automated trading are')} Martingale, D'Alembert, ${localize('and')} Oscar's Grind — ${localize('you can find them all ready-made and waiting for you in TradeLab Bot.')}`,
            },
        ],
        search_id: 'faq-16',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    '<a href="https://www.youtube.com/watch?v=QdI5zCkO4Gk&t=203s" target="_blank">Watch this video</a> to learn how to build a trading bot on TradeLab Bot. Also, <a href="https://deriv.com/academy/blog/posts/how-to-build-a-basic-trading-bot-with-dbot/" target="_blank">check out this blog post</a> on building a trading bot.'
                ),
            },
        ],
        search_id: 'faq-17',
...
export const quick_strategy_content = (): TQuickStrategyContent[] => [
    {
        ...
        content: [
            `${localize('Exploring the')} Martingale ${localize('strategy in TradeLab Bot')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} D'Alembert ${localize('strategy in TradeLab Bot')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} Oscar's Grind ${localize('strategy in TradeLab Bot')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} Reverse Martingale ${localize('strategy in TradeLab Bot')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} Reverse D'Alembert ${localize('strategy in TradeLab Bot')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} 1-3-2-6 ${localize('strategy in TradeLab Bot')}`,
