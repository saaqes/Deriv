...
// Reads the refresh_token from storage even when the access_token has
// expired (getAuthInfo() returns null in that case). Used to silently renew
// the session on load instead of forcing the user through OAuth again.
